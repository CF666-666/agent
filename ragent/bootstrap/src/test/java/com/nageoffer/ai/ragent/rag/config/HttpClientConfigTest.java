...
class HttpClientConfigTest {
    ...
    @Test
    void shouldBoundOptionalRerankCallByConfiguredBudget() {
        OkHttpClient client = new HttpClientConfig().rerankHttpClient(3000);

        assertThat(client.connectTimeoutMillis()).isEqualTo(3000);
        assertThat(client.writeTimeoutMillis()).isEqualTo(3000);
