...
CREATE INDEX idx_hyperedge_document_active ON t_hyperedge (source_document) WHERE deleted = 0;
COMMENT ON TABLE t_hyperedge IS '工业关系超边表';
