...
| 8.2-C | 隔离服务 A/B 重跑 | 🚧 进行中 | 08-06 | - | 已完成 `retrievalOnly`、报告级 `latency_ms`/状态/P50/P95、Rerank 3s 预算及意图分类隔离；A 组 5 条探针 296--1985ms 且无缺失。完整 A/B/C/D 报告仍待重跑，不得使用历史快照更新对外指标 |
