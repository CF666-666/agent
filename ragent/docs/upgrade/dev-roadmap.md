...
| 8.2-C | 隔离服务 A/B 重跑 | 🚧 进行中 | 08-06 | - | 已完成 `retrievalOnly`、报告级 `latency_ms`/状态/P50/P95、Rerank 3s 预算及意图分类隔离；A/B/C 的 50/25/25 条原始及合并报告已重跑，D 全链路 100 条待执行。仅 A/B/C 指标可核验，不得外推为融合结论 |
